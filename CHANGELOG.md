## 2.2.1
* Исправлена ошибка эскортирования для корабля игрока

## 2.2.0
* Исправлена ошибка автоповорота
* Исправлена ошибка сопровождения
* Изменена горячая клавиша сохранения:
    * Более не требуется страховка для сохранения игры.
    * Теперь при сохранении игры не выводится запрос подтверждения.
    * Больше не издается предупреждающий звук при переходе от сохранения 10 к сохранению 1
